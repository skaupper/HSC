...
void cordic_cc::calc() {
#pragma HLS RESOURCE variable = iStart core = AXI4LiteS metadata = \
    "-bus_bundle cordic_if"
#pragma HLS RESOURCE variable = iPhi core = AXI4LiteS metadata = \
    "-bus_bundle cordic_if"
#pragma HLS RESOURCE variable = oX core = AXI4LiteS metadata = \
    "-bus_bundle cordic_if"
#pragma HLS RESOURCE variable = oY core = AXI4LiteS metadata = \
    "-bus_bundle cordic_if"
#pragma HLS RESOURCE variable = oRdy core = AXI4LiteS metadata = \
    "-bus_bundle cordic_if"
...
#pragma HLS RESOURCE variable = ATAN_LUT core = ROM_nP
  ...
  while (true) {
    ...
    // cout << "## Start Cordic Calculation Iteration " << currentIter << " @ "
    // << sc_time_stamp() << endl;
